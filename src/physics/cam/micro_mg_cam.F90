...
real(r8)          :: micro_mg_accre_enhan_fact = unset_r8
...
!ppe
  ...
  if (masterproc) then
     ...
     write(iulog,*) '  micro_mg_accre_enhan_fact = ', micro_mg_accre_enhan_fact !ppe
   ...
   case (2)
      ...
      case (0)
         call micro_mg_init2_0( &
              ...
              micro_mg_nccons, micro_mg_nicons, micro_mg_ncnst, &
              micro_mg_ninst, micro_mg_accre_enhan_fact, &
              ...
              micro_mg_max_nicons, errstring)!ppe
      end select
   end select
